...
<xsl:variable name="wesmere-css-version" select="'1.1.9'"/>
...
<div id="content" role="main">
	...
	<xsl:if test="document/@is-maintenance-page">
		<p>In the meantime, you might be interested in checking out our <a href="https://discord.gg/battleforwesnoth"><b>official Discord server</b></a>, our <abbr title="Internet Relay Chat">IRC</abbr> channel <a href="https://web.libera.chat/#wesnoth"><b>#wesnoth</b></a> on <code class="noframe">irc.libera.chat</code>, or following <a href="https://twitter.com/Wesnoth"><b>@Wesnoth</b></a> on Twitter for status updates!</p>
