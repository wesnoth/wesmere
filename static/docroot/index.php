...
$branches = [
	...
	[
		...
		'update-announcement' => 'https://forums.wesnoth.org/viewtopic.php?t=56873',

		'release-notes' => [ 'url' => '/start/1.16/', 'label' => 'Release notes for 1.16' ],

		'files-url-prefix' => 'https://sourceforge.net/projects/wesnoth/files/wesnoth-1.16/wesnoth-1.16.9',
		...
		[
			...
			[
				'os'    => 'apple',
				'label' => 'macOS (10.12+)',
				'url'   => 'https://sourceforge.net/projects/wesnoth/files/wesnoth-1.16/wesnoth-1.16.9/Wesnoth_1.16.9.dmg/download',
			],
			[
				'os'    => 'linux',
			...
			[
				'os'    => 'src',
				'url'   => '@/wesnoth-1.16.9.tar.bz2/download',
			],
			/*[
				'os'    => 'ios',
	...
	[
		...
		'update-announcement' => 'https://forums.wesnoth.org/viewtopic.php?t=56791',

		'files-url-prefix' => 'https://sourceforge.net/projects/wesnoth/files/wesnoth/wesnoth-1.17.14',
		...
		[
			...
			[
				'os'    => 'apple',
				'label' => 'macOS (10.12+)',
				'url'   => 'https://sourceforge.net/projects/wesnoth/files/wesnoth/wesnoth-1.17.14/Wesnoth_1.17.14.dmg/download',
			],
			[
				'os'    => 'linux',
			...
			[
				'os'    => 'src',
				'url'   => '@/wesnoth-1.17.14.tar.bz2/download',
			],
		],
