...
$branches = [
	...
	[
		...
		'update-announcement' => 'https://forums.wesnoth.org/viewtopic.php?t=56231',

		'release-notes' => [ 'url' => '/start/1.16/', 'label' => 'Release notes for 1.16' ],

		'files-url-prefix' => 'https://sourceforge.net/projects/wesnoth/files/wesnoth-1.16/wesnoth-1.16.6',
		...
		[
			...
			[
				'os'    => 'src',
				'url'   => '@/wesnoth-1.16.6.tar.bz2/download',
			],
			/*[
				'os'    => 'ios',
	...
	[
		...
		'update-announcement' => 'https://forums.wesnoth.org/viewtopic.php?t=56321',

		'files-url-prefix' => 'https://sourceforge.net/projects/wesnoth/files/wesnoth/wesnoth-1.17.9',
		...
		[
			...
			[
				'os'    => 'apple',
				'label' => 'macOS (10.12+)',
				'url'   => '@/Wesnoth_1.17.9.dmg/download',
			],
			[
				'os'    => 'linux',
			...
			[
				'os'    => 'src',
				'url'   => '@/wesnoth-1.17.9.tar.bz2/download',
			],
		],
