...
$branches = [
	...
	[
		...
		'update-announcement' => 'https://forums.wesnoth.org/viewtopic.php?t=57237',

		'files-url-prefix' => 'https://sourceforge.net/projects/wesnoth/files/wesnoth/wesnoth-1.17.21',
		...
		[
			...
			[
				'os'    => 'apple',
				'label' => 'macOS (10.12+)',
				'url'   => 'https://sourceforge.net/projects/wesnoth/files/wesnoth/wesnoth-1.17.20/Wesnoth_1.17.20.dmg/download',
			],
			[
				'os'    => 'linux',
			...
			[
				'os'    => 'src',
				'url'   => '@/wesnoth-1.17.21.tar.bz2/download',
			],
		],
