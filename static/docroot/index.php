...
$branches = [
	...
	[
		...
		'update-announcement' => 'https://forums.wesnoth.org/viewtopic.php?t=50901',

		'release-notes' => [ 'url' => '/start/1.14/', 'label' => 'Release notes for 1.14' ],

		'files-url-prefix' => 'https://sourceforge.net/projects/wesnoth/files/wesnoth-1.14/wesnoth-1.14.9',
		...
		[
			[
				'os'    => 'windows',
				'size'  => '411.7',
				'url'   => '@/wesnoth-1.14.9-win32.exe/download',
			],
			[
				'os'    => 'apple',
				'label' => 'macOS',
				'size'  => '467.7',
				'url'   => '@/Wesnoth_1.14.9.dmg/download',
			],
			[
				'os'    => 'src',
				'size'  => '456.4',
				'url'   => '@/wesnoth-1.14.9.tar.bz2/download',
			],
			[
				'os'    => 'linux',
	...
	[
		...
		'update-announcement' => 'https://forums.wesnoth.org/viewtopic.php?t=51039',

		'files-url-prefix' => 'https://sourceforge.net/projects/wesnoth/files/wesnoth/wesnoth-1.15.2',
		...
		[
			...
			[
				'os'    => 'src',
				'size'  => '459.6',
				'url'   => '@/wesnoth-1.15.2.tar.bz2/download',
			],
			[
				'os'    => 'linux',
				'url'   => 'https://wiki.wesnoth.org/WesnothBinariesLinux',
...
<div id="footer"><div id="footer-content"><div>
	...
	Copyright &copy; 2003&ndash;2019 by <a rel="author" href="https://wiki.wesnoth.org/Project">The Battle for Wesnoth Project</a>. Supported by <a href="http://www.jexiste.fr/">Jexiste</a>.<br />
	Site design Copyright &copy; 2017&ndash;2019 by Iris Morelle.
</div></div></div>
