...
$branches = [
	...
	[
		...
		'update-announcement' => 'https://forums.wesnoth.org/viewtopic.php?t=60700',

		'files-url-prefix' => 'https://sourceforge.net/projects/wesnoth/files/wesnoth/wesnoth-1.19.24',
		...
		[
			...
			[
				'os'    => 'src',
				'url'   => '@/wesnoth-1.19.24.tar.bz2/download',
			],
			[
				'os'    => 'android',
