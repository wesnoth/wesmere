...
$branches = [
	...
	[
		...
		'update-announcement' => 'https://forums.wesnoth.org/viewtopic.php?t=56589',

		'files-url-prefix' => 'https://sourceforge.net/projects/wesnoth/files/wesnoth/wesnoth-1.17.12',
		...
		[
			...
			[
				'os'    => 'src',
				'url'   => '@/wesnoth-1.17.12.tar.bz2/download',
			],
		],
