...
$branches = [
	...
	[
		...
		'update-announcement' => 'https://forums.wesnoth.org/viewtopic.php?t=51760',

		'release-notes' => [ 'url' => '/start/1.14/', 'label' => 'Release notes for 1.14' ],

		'files-url-prefix' => 'https://sourceforge.net/projects/wesnoth/files/wesnoth-1.14/wesnoth-1.14.11',
		...
		[
			[
				'os'    => 'windows',
				'size'  => '414.0',
				'url'   => '@/wesnoth-1.14.11-win32.exe/download',
			],
			[
				'os'    => 'apple',
				'label' => 'macOS',
				'size'  => '468.0',
				'url'   => '@/Wesnoth_1.14.11.dmg/download',
			],
			[
				'os'    => 'src',
				'size'  => '458.9',
				'url'   => '@/wesnoth-1.14.11.tar.bz2/download',
			],
			[
				'os'    => 'linux',
	...
	[
		...
		'update-announcement' => 'https://forums.wesnoth.org/viewtopic.php?t=52194',

		'files-url-prefix' => 'https://sourceforge.net/projects/wesnoth/files/wesnoth/wesnoth-1.15.3',
		...
		[
			[
				...
				'size'  => '423.6',
				'url'   => '@/wesnoth-1.15.3-win64.exe/download',
			],
			[
				'os'    => 'apple',
				'label' => 'macOS (10.8+)',
				'size'  => '444.3',
				'url'   => '@/Wesnoth_1.15.3.dmg/download',
			],
			[
				'os'    => 'src',
				'size'  => '455.1',
				'url'   => '@/wesnoth-1.15.3.tar.bz2/download',
			],
			[
				'os'    => 'linux',
				'url'   => 'https://wiki.wesnoth.org/WesnothBinariesLinux',
