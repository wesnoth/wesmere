...
$branches = [
	...
	[
		...
		'update-announcement' => 'https://forums.wesnoth.org/viewtopic.php?t=53737',

		'release-notes' => [ 'url' => '/start/1.14/', 'label' => 'Release notes for 1.14' ],

		'files-url-prefix' => 'https://sourceforge.net/projects/wesnoth/files/wesnoth-1.14/wesnoth-1.14.15',
		...
		[
			[
				'os'    => 'windows',
				'size'  => '415.3',
				'url'   => '@/wesnoth-1.14.15-win32.exe/download',
			],
			[
				'os'    => 'apple',
				'label' => 'macOS',
				'size'  => '453.6',
				'url'   => '@/Wesnoth_1.14.15.dmg/download',
			],
			[
				'os'    => 'src',
				'size'  => '461.8',
				'url'   => '@/wesnoth-1.14.15.tar.bz2/download',
			],
			[
				'os'    => 'linux',
	...
	[
		...
		'update-announcement' => 'https://forums.wesnoth.org/viewtopic.php?t=53848',

		'files-url-prefix' => 'https://sourceforge.net/projects/wesnoth/files/wesnoth/wesnoth-1.15.9',
		...
		[
			[
				...
				'size'  => '435.7',
				'url'   => '@/wesnoth-1.15.9-win64.exe/download',
			],
			[
				'os'    => 'apple',
				'label' => 'macOS (10.11+)',
				'size'  => '479.1',
				'url'   => '@/Wesnoth_1.15.9.dmg/download',
			],
			[
				'os'    => 'src',
				'size'  => '467.2',
				'url'   => '@/wesnoth-1.15.9.tar.bz2/download',
			],
			[
				'os'    => 'linux',
				'url'   => 'https://wiki.wesnoth.org/WesnothBinariesLinux',
...
<div id="footer"><div id="footer-content"><div>
	...
	Copyright &copy; 2003&ndash;2020 by <a rel="author" href="https://wiki.wesnoth.org/Project">The Battle for Wesnoth Project</a>. Supported by <a href="http://www.jexiste.fr/">Jexiste</a>.<br />
