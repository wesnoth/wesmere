...
$branches = [
	...
	[
		...
		'update-announcement' => 'https://forums.wesnoth.org/viewtopic.php?t=54085',

		'release-notes' => [ 'url' => '/start/1.14/', 'label' => 'Release notes for 1.14' ],

		'files-url-prefix' => 'https://sourceforge.net/projects/wesnoth/files/wesnoth-1.14/wesnoth-1.14.16',
		...
		[
			[
				'os'    => 'windows',
				'size'  => '415.8',
				'url'   => '@/wesnoth-1.14.16-win32.exe/download',
			],
			[
				'os'    => 'apple',
				'label' => 'macOS',
				'size'  => '454.6',
				'url'   => '@/Wesnoth_1.14.16.dmg/download',
			],
			[
				'os'    => 'src',
				'size'  => '462.5',
				'url'   => '@/wesnoth-1.14.16.tar.bz2/download',
			],
			[
				'os'    => 'linux',
	...
	[
		...
		'update-announcement' => 'https://forums.wesnoth.org/viewtopic.php?t=54224',

		'files-url-prefix' => 'https://sourceforge.net/projects/wesnoth/files/wesnoth/wesnoth-1.15.12',
		...
		[
			[
				...
				'size'  => '437.3',
				'url'   => '@/wesnoth-1.15.12-win64.exe/download',
			],
			[
				'os'    => 'apple',
				'label' => 'macOS (10.11+)',
				'size'  => '482.0',
				'url'   => '@/Wesnoth_1.15.12.dmg/download',
			],
			[
				'os'    => 'src',
				'size'  => '468.5',
				'url'   => '@/wesnoth-1.15.12.tar.bz2/download',
			],
			[
				'os'    => 'linux',
				'url'   => 'https://wiki.wesnoth.org/WesnothBinariesLinux',
