...
$branches = [
	...
	[
		...
		'files-url-prefix' => 'https://sourceforge.net/projects/wesnoth/files/wesnoth-1.16/wesnoth-1.16.2',
	...
	[
		...
		'update-announcement' => 'https://forums.wesnoth.org/viewtopic.php?t=55532',

		'files-url-prefix' => 'https://sourceforge.net/projects/wesnoth/files/wesnoth/wesnoth-1.17.2',
		...
		[
			[
				...
				'label' => 'Windows (64-bit)',
				'size'  => '445.3',
				'url'   => '@/wesnoth-1.17.2-win64.exe/download',
			],
			[
				'os'    => 'apple',
				'label' => 'macOS (10.11+)',
				'size'  => '490.0',
				'url'   => '@/Wesnoth_1.17.2.dmg/download',
			],
			[
				'os'    => 'src',
				'size'  => '478.6',
				'url'   => '@/wesnoth-1.17.2.tar.bz2/download',
			],
			[
				'os'    => 'linux',
