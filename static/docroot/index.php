...
$branches = [
	...
	[
		...
		'update-announcement' => 'https://forums.wesnoth.org/viewtopic.php?t=60945',

		'files-url-prefix' => 'https://sourceforge.net/projects/wesnoth/files/wesnoth/wesnoth-1.19.28',
		...
		[
			...
			[
				'os'    => 'src',
				'url'   => '@/wesnoth-1.19.28.tar.bz2/download',
			],
			[
				'os'    => 'android',
