...
$branches = [
	...
	[
		...
		'update-announcement' => 'https://forums.wesnoth.org/viewtopic.php?t=57081',

		'files-url-prefix' => 'https://sourceforge.net/projects/wesnoth/files/wesnoth/wesnoth-1.17.19',
		...
		[
			...
			[
				'os'    => 'apple',
				'label' => 'macOS (10.12+)',
				'url'   => 'https://sourceforge.net/projects/wesnoth/files/wesnoth/wesnoth-1.17.19/Wesnoth_1.17.19.dmg/download',
			],
			[
				'os'    => 'linux',
			...
			[
				'os'    => 'src',
				'url'   => '@/wesnoth-1.17.19.tar.bz2/download',
			],
		],
